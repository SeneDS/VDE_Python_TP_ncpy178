...
# Charger les credentials Firebase depuis une variable d'environnement ou un fichier JSON
...
class GestionnaireContact:
    ...
    def afficher_contacts(self):
        """Récupère tous les contacts depuis Firebase."""
        try:
            return self.ref.get()
        except Exception as e:
